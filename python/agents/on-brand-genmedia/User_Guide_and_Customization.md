...
## Objective
This document demonstrates the On-Brand MediaGen Agent in action, showing how users can use the agent and how developers can customize it with their own digital assets and search logic.

## NeuroVibe AI Brand
The agent is designed to generate media that adheres to the **NeuroVibe AI** brand guidelines. For detailed information on the brand colors, logos, and style, please refer to the [NeuroVibe AI Brand Guidelines](on_brand_genmedia/data/NeuroVibe_AI_Brand_Guidelines.pdf).
...
| Cognitive White T-Shirt | NeuroBlue T-Shirt | NeuroVibe AI Office Reception | Associate Badge |
| :---: | :---: | :---: | :---: |
| <img src="on_brand_genmedia/data/assets/Cognitive_White_T_Shirt_with_full_primary_logo.png" width="150" alt="White T-Shirt" /> | <img src="on_brand_genmedia/data/assets/NeuroBlue_T_shirt_with_pulse_arrow_logo.png" width="150" alt="Blue T-Shirt" /> | <img src="on_brand_genmedia/data/assets/NeuroVibe_AI_office_reception.png" width="150" alt="Office Reception" /> | <img src="on_brand_genmedia/data/assets/associate_badge.png" width="150" alt="Associate Badge" /> |
...
![Professional Male in Reception](on_brand_genmedia/data/generated_images/NeuroVibe_employee_by_the_reception.png)
...
![Female Employee in Merchandise](on_brand_genmedia/data/generated_images/NeuroVibe_employee_in_company_merchandise.png)

---

### Example 3
**Prompt:** "Come up with a creative image of NeuroVibe office reception"

![NeuroVibe Reception Area](on_brand_genmedia/data/generated_images/NeuroVibe_reception.png)
...
2.  **Update Metadata**: Open `on_brand_genmedia/data/brand_assets_metadata.json` and add an entry for the new asset.
